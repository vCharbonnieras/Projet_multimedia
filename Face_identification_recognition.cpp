...
void identificationandrecognition(Mat frame, Mat frame_gray,String winname) {
...
/** Fonction main */
int face(Mat img,String winname) {
    ...
    */
    ...
    identificationandrecognition(colorImage, grayImage,winname);
